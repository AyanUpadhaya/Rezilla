...
const RegisterNow = () => {
  return (
    <div className='w-full h-full  py-20 lg:py-[100px] '>
        <div className='  container mx-auto lg:bg-white bg-primary h-full  rounded-[30px] relative flex flex-col lg:flex-row items-center lg:px-5 px-[30px]  lg:after:content-[""] lg:after:absolute lg:after:left-0 lg:after:bottom-0 lg:after:w-full lg:after:h-[85%]  lg:after:z-50 lg:after:bg-primary lg:after:rounded-[30px]'>
